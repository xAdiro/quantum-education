...
\chapter{Podstawy teorytyczne}
	...
	Szczegóły funkcji falowej $\psi$ wytłumaczone są w dalszej części pracy, jednak na szczególną uwagę zasługuje wartość kwadratu jej modułu, określająca gęstość prawdopobieństwa znalezienia cząstki w danym położeniu. Oznacza to, że prawdopobieństwo to będziemy wyznaczać jako:
	\begin{center}
	...
	Dalej omawiane Równanie Schrödingera, jest równaniem różniczkowym tj. takim zawierającym pochodne funkcji $\psi$, które należy rozwiązać, aby znaleźć równanie $\psi$. Jednak wybrany zakres zagadnień wymaga jedynie umiejętności rozwiązani dwóch rodzajów równań:
	...
	$A \in \mathbb{R}, B \in \mathbb{R}, K \in \mathbb{C}$\textcolor{red}{C?}
